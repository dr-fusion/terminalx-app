...
export default function LoginPage() {
  ...
  return (
    <div className="flex h-screen items-center justify-center bg-[#0a0b10] px-4">
      <div className="w-full max-w-[400px]">
        {/* Wordmark */}
        <div className="mb-6 text-center">
          <h1
            className="text-[24px] font-bold text-[#00cc6e]"
        ...
        <Card className="border-[#1a1d24] bg-[#0f1117]">
          <CardContent className="pt-6">
            {authMode === "google" ? (
              <div className="flex flex-col gap-4">
                ...
                {error && (
                  <Alert variant="destructive" className="border-[#ff5c5c]/30 bg-[#ff5c5c]/10">
                    <AlertCircle className="h-4 w-4" />
                    <AlertDescription className="text-[#ff5c5c]">{error}</AlertDescription>
                  </Alert>
                )}
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                {authMode === "local" && (
                  <div className="flex flex-col gap-2">
                    <Label htmlFor="username" className="text-[#e6f0e4]">
                      Username
                    </Label>
                    <Input
                      id="username"
                ...
                <div className="flex flex-col gap-2">
                  <Label htmlFor="password" className="text-[#e6f0e4]">
                    Password
                  </Label>
                  <Input
                    id="password"
                ...
                <Button
                  ...
                  className="w-full bg-[#00cc6e] text-white hover:bg-[#00ff88] disabled:opacity-50"
                >
                  {isSubmitting ? (
                    <>
