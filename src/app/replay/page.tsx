  ...
  return (
    <div className="h-dvh w-screen flex flex-col bg-[#0a0b10] overflow-hidden">
      <div className="flex items-center h-11 px-3 bg-[#0f1117] border-b border-[#1a1d24] shrink-0 gap-3">
        <Link
          href="/"
          className="flex items-center gap-1.5 text-[#899384] hover:text-[#e6f0e4] transition-colors text-[13px]"
        >
          <ArrowLeft size={14} />
          Back
        </Link>
      ...
      <div className="flex-1 overflow-y-auto p-4 max-w-3xl w-full mx-auto">
        {!enabled && (
          <div className="mb-4 px-3 py-2 rounded bg-[#14161e] border border-[#1a1d24] text-[12px] text-[#899384]">
        ...
        {error ? (
          ...
          <div className="text-[#899384] text-[13px] text-center py-8">No recordings yet</div>
        ) : (
            ...
            {recordings.map((r) => (
              <li key={r.id}>
                ...
                >
                  <Film
                    size={16}
                    className="text-[#899384] group-hover:text-[#00cc6e] transition-colors"
                  />
                  <div className="flex-1 min-w-0">
                    <div className="text-[#e6f0e4] text-[13px] font-medium truncate">
                      {r.sessionId || r.id}
                    </div>
                    <div className="text-[11px] text-[#899384]">
