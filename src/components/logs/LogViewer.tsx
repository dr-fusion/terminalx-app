...
export function LogViewer() {
  ...
  const wsUrl = selectedLog ? `/ws/logs/${encodeURIComponent(selectedLog.path)}` : null;
  ...
  return (
    <div className="flex flex-col h-full text-[13px] font-sans">
      <div className="flex flex-col gap-1.5 px-2 py-2 border-b border-[#1a1d24]">
        <select
          ...
          className="w-full bg-[#14161e] text-[#e6f0e4] border border-[#1a1d24]
            rounded px-2 py-1 text-[12px] outline-none focus:border-[#00cc6e]"
        >
      ...
      {selectedLog && (
        <div className="flex items-center gap-1.5 px-2 py-1 border-b border-[#1a1d24] text-[11px]">
          <span
